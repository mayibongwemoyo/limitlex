    ...
    <section id="ft-breadcrumb" class="ft-breadcrumb-section position-relative" data-background="assets/img/bg/bread-bg.jpg">
        ...
        <div class="container">
            <div class="ft-breadcrumb-content headline text-center position-relative">
                <h2>Procurement and Supply Chain Management</h2>
                    ...
                    <div class="col-lg-8">
                        <div class="ft-service-details-content-wrapper headline pera-content">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="ft-service-details-img">
                                            <img src="assets/img/service/source1.png" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="ft-service-details-img">
                                            <img src="assets/img/service/source2.png" alt="">
                                        </div>
                                        <div class="ft-service-details-img">
                                            <img src="assets/img/service/source3.png" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="ft-service-details-text-wrapper">
                                <h3>Overview</h3>
                                <p>We take great effort into finding the most reliable, credible, and verified suppliers to
                                    acquire the goods your organization requires. Our service includes sourcing, negotiating
                                    prices, sealing contracts, and settling payments on your behalf. Our goal is to optimize
                                    your supply chain so it runs as smoothly as possible, eliminating friction, and ensuring
                                    the entire process of producing goods or services, all the way to delivering them to the
                                    end-users functions seamlessly.
