                        ...
                        <form method="POST" action="{{ route('contact-form.store') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="affi" class="form-control" placeholder="Affiliation" value="{{ old('affi') }}">

                                    @if ($errors->has('affi'))

                                        <span class="text-danger">{{ $errors->first('affi') }}</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="department" class="form-control" placeholder="Inquiry Department" value="{{ old('department') }}">
